...
.home-hero{display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:12px 32px 32px;min-height:260px;}
...
.home-cta{display:inline-flex;align-items:center;gap:10px;padding:14px 32px;background:var(--blue);color:white;border:none;border-radius:10px;cursor:pointer;font-family:var(--sans);font-size:15px;font-weight:700;transition:all 0.2s;box-shadow:0 4px 20px rgba(59,91,219,0.3);margin-bottom:24px;}
...
.ai-disclaimer{text-align:center;font-size:10.5px;font-family:var(--mono);color:var(--ink4);padding:10px 20px 18px;letter-spacing:0.03em;border-top:1px solid var(--border);margin-top:32px;}
.metrics-strip{display:flex;justify-content:center;gap:28px;padding:10px 0;margin-bottom:24px;border-top:1px solid var(--border);border-bottom:1px solid var(--border);background:var(--bg2);border-radius:8px;}
.ms-item{text-align:center;}
.ms-val{font-size:15px;font-weight:800;color:var(--blue);font-family:var(--mono);}
.ms-lbl{font-size:9px;color:var(--ink3);font-family:var(--mono);text-transform:uppercase;letter-spacing:0.08em;}
  ...
  return (
    <div className="page-in">
      <div className="home-hero">
        ...
        <div style={{ width: "100%", maxWidth: 520, margin: "0 auto 32px", borderRadius: 14, overflow: "hidden", border: "1px solid var(--border)", boxShadow: "0 8px 32px rgba(59,91,219,0.12)", position: "relative", background: "#0f1623", minHeight: 200, display: "flex", alignItems: "center", justifyContent: "center" }}>
          <svg viewBox="0 0 520 200" xmlns="http://www.w3.org/2000/svg" style={{ width: "100%", display: "block" }}>
            <defs>
            ...
            <rect width="520" height="200" fill="url(#bgGrad)" />
            {/* Grid lines */}
            {[40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480].map(x => (
              <line key={x} x1={x} y1="0" x2={x} y2="200" stroke="#ffffff08" strokeWidth="1" />
            ))}
            {[40, 80, 120, 160].map(y => (
            ...
            <g transform="translate(220,60)">
              <path d="M40 0 L80 15 L80 55 Q80 80 40 95 Q0 80 0 55 L0 15 Z" fill="#3b5bdb22" stroke="#3b5bdb" strokeWidth="1.5" />
              <path d="M40 20 L60 30 L60 55 Q60 70 40 78 Q20 70 20 55 L20 30 Z" fill="#3b5bdb44" stroke="#4c6ef5" strokeWidth="1" />
              <text x="40" y="62" textAnchor="middle" fill="white" fontSize="20" fontWeight="bold" fontFamily="monospace">✓</text>
            </g>
            {/* Floating data nodes */}
            <circle cx="80" cy="60" r="18" fill="#ef444420" stroke="#ef4444" strokeWidth="1.2" />
            <text x="80" y="65" textAnchor="middle" fill="#ef4444" fontSize="11" fontFamily="monospace">SCAM</text>
            <circle cx="440" cy="60" r="18" fill="#22c55e20" stroke="#22c55e" strokeWidth="1.2" />
            <text x="440" y="65" textAnchor="middle" fill="#22c55e" fontSize="11" fontFamily="monospace">SAFE</text>
            <circle cx="80" cy="145" r="14" fill="#f59e0b18" stroke="#f59e0b" strokeWidth="1" />
            <text x="80" y="150" textAnchor="middle" fill="#f59e0b" fontSize="9" fontFamily="monospace">URL</text>
            <circle cx="440" cy="145" r="14" fill="#8b5cf618" stroke="#8b5cf6" strokeWidth="1" />
            <text x="440" y="150" textAnchor="middle" fill="#8b5cf6" fontSize="9" fontFamily="monospace">ML</text>
            {/* Connecting lines */}
            <line x1="98" y1="60" x2="220" y2="95" stroke="#3b5bdb40" strokeWidth="1" strokeDasharray="4,3" />
            <line x1="300" y1="95" x2="422" y2="60" stroke="#22c55e40" strokeWidth="1" strokeDasharray="4,3" />
            <line x1="94" y1="145" x2="220" y2="120" stroke="#f59e0b30" strokeWidth="1" strokeDasharray="4,3" />
            <line x1="300" y1="120" x2="426" y2="145" stroke="#8b5cf640" strokeWidth="1" strokeDasharray="4,3" />
            {/* Stats bar at bottom */}
            <rect x="0" y="172" width="520" height="28" fill="#ffffff06" />
            <text x="60" y="190" textAnchor="middle" fill="#3b82f6" fontSize="11" fontWeight="bold" fontFamily="monospace">95.0%</text>
            <text x="60" y="197" textAnchor="middle" fill="#4b5680" fontSize="8" fontFamily="monospace">ACCURACY</text>
            <line x1="110" y1="176" x2="110" y2="196" stroke="#ffffff15" strokeWidth="1" />
            <text x="175" y="190" textAnchor="middle" fill="#22c55e" fontSize="11" fontWeight="bold" fontFamily="monospace">1,500</text>
            <text x="175" y="197" textAnchor="middle" fill="#4b5680" fontSize="8" fontFamily="monospace">SAMPLES</text>
            <line x1="235" y1="176" x2="235" y2="196" stroke="#ffffff15" strokeWidth="1" />
            <text x="300" y="190" textAnchor="middle" fill="#f59e0b" fontSize="11" fontWeight="bold" fontFamily="monospace">23</text>
            <text x="300" y="197" textAnchor="middle" fill="#4b5680" fontSize="8" fontFamily="monospace">FEATURES</text>
            <line x1="350" y1="176" x2="350" y2="196" stroke="#ffffff15" strokeWidth="1" />
            <text x="430" y="190" textAnchor="middle" fill="#ef4444" fontSize="11" fontWeight="bold" fontFamily="monospace">16.7%</text>
            <text x="430" y="197" textAnchor="middle" fill="#4b5680" fontSize="8" fontFamily="monospace">SCAM RATE</text>
            {/* Title overlay */}
            <text x="260" y="30" textAnchor="middle" fill="#ffffff60" fontSize="10" fontFamily="monospace" letterSpacing="3">AI-POWERED SCAM DETECTION</text>
          </svg>
        </div>
...
function DashboardPage({ setPage }) {
  ...
  const donutSegments = useMemo(
    () => SCAM_DIST.map((item, index) => ({
      ...item,
      offset: SCAM_DIST.slice(0, index).reduce((sum, current) => sum + current.pct, 0),
    })),
    []
  );
  return (
    <div className="page-in">
      ...
      <div className="metrics-strip mb24">
        {[
          { val: "95.0%", lbl: "Accuracy" },
          { val: "98.0%", lbl: "Precision" },
          { val: "90.7%", lbl: "Recall" },
          { val: "94.2%", lbl: "F1 Score" },
          { val: "1,500", lbl: "Samples" },
          { val: "23", lbl: "Features" },
          { val: "2", lbl: "Models" },
        ].map(m => (
          <div key={m.lbl} className="ms-item">
            <div className="ms-val">{m.val}</div>
            <div className="ms-lbl">{m.lbl}</div>
          </div>
        ))}
      </div>
      ...
      <div className="stat-row">
        {[
          ...
          { label: "Model Accuracy", val: `${DATASET_STATS.modelAccuracy}%`, delta: "NB + LR Ensemble · 23 features", c: "#8b5cf6" },
        ].map(s => (
              ...
              {donutSegments.map(t => {
                ...
                return (
                  <circle key={t.label} cx="50" cy="50" r="38" fill="none"
                    ...
                    strokeDashoffset={-((t.offset / 100) * c)}
                  />
                );
              })}
            </svg>
...
function AboutPage() {
  return (
    <div className="page-in">
        ...
        {[
          {
            label: "Model",
            val: "NB + LR Ensemble",
            sub: "Naive Bayes + Logistic Regression"
          },
          {
            label: "Dataset",
            val: `${DATASET_STATS.totalSamples} Samples`,
            sub: `${DATASET_STATS.scamSamples} scam · ${DATASET_STATS.legitSamples} legit`
          },
          {
            label: "Accuracy",
            val: `${DATASET_STATS.modelAccuracy}%`,
            sub: "Held-out benchmark dataset"
          },
          {
            label: "Precision",
            val: `${DATASET_STATS.precision}%`,
            sub: "Low false positive rate"
          },
          {
            label: "Recall",
            val: `${DATASET_STATS.recall}%`,
            sub: "Scam detection coverage"
          },
          {
            label: "F1 Score",
            val: `${DATASET_STATS.f1Score}%`,
            sub: "Balanced performance metric"
          },
          {
            label: "Features",
            val: `${DATASET_STATS.features}`,
            sub: "Text + URL + Payment signals"
          },
        ].map(s => (
      ...
      <div className="arch-block mb24" style={{ lineHeight: "2.4" }}>
        <div style={{ color: "#fbbf24", fontWeight: 600 }}>[ Input Text ]</div>
        <div style={{ color: "#4b5680", paddingLeft: 4 }}>↓</div>
        <div style={{ paddingLeft: 4 }}>preprocess() — lowercase, remove stopwords</div>
        <div style={{ color: "#4b5680", paddingLeft: 4 }}>↓</div>
        <div style={{ paddingLeft: 4 }}>extract_features() — {DATASET_STATS.features} binary/numeric features</div>
        <div style={{ color: "#4b5680", paddingLeft: 4 }}>↓</div>
        <div style={{ color: "#7eb8ff" }}>NaiveBayes.predict_proba() + LogisticRegression.predict_proba()</div>
        <div style={{ color: "#4b5680", paddingLeft: 4 }}>↓</div>
        <div>Ensemble: 50% NB + 50% LR → scam_probability</div>
        <div style={{ color: "#4b5680", paddingLeft: 4 }}>↓</div>
        <div style={{ color: "#c4b5fd" }}>analyze_url() + detect_payment() + get_domain_trust()</div>
        <div style={{ color: "#4b5680", paddingLeft: 4 }}>↓</div>
        <div style={{ color: "#34d399", fontWeight: 600 }}>[ Final Risk Score + Risk Label ]</div>
      </div>
        ...
        <aside className="sb">
          ...
          <div className="sb-footer">
            ...
            <div className="sb-build">
              Dataset: {DATASET_STATS.totalSamples} samples · Acc: {DATASET_STATS.modelAccuracy}% · F1: {DATASET_STATS.f1Score}%
            </div>
          </div>
        </aside>
        <div className="carea">
          ...
          <div className="tbody">
            ...
            <div className="ai-disclaimer">⚠ AI predictions are probabilistic — always verify employers through official channels</div>
          </div>
        </div>
      </div>
    </>
